 ...
 */
final class Version20180730161234 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE municipio (id INT AUTO_INCREMENT NOT NULL, codigo INT NOT NULL, nome VARCHAR(255) NOT NULL, uf VARCHAR(2) NOT NULL, idUf INT DEFAULT NULL, INDEX IDX_FE98F5E04BA96915 (idUf), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE municipio ADD CONSTRAINT FK_FE98F5E04BA96915 FOREIGN KEY (idUf) REFERENCES estado (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE municipio DROP FOREIGN KEY FK_FE98F5E04BA96915');
