...
class Unit extends \App\Entity\Unit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'initials', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'name'];
        }
     ...
     * {@inheritDoc}
     */
    public function setInitials(string $initials): \App\Entity\Unit
    {
