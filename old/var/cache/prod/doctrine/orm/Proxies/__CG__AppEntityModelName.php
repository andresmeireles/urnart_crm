 ...
 */
class ModelName extends \App\Entity\ModelName implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ModelName' . "\0" . 'id', '' . "\0" . 'App\\Entity\\ModelName' . "\0" . 'name', '' . "\0" . 'App\\Entity\\ModelName' . "\0" . 'suggestedPrice', '' . "\0" . 'App\\Entity\\ModelName' . "\0" . 'colors', '' . "\0" . 'App\\Entity\\ModelName' . "\0" . 'height', '' . "\0" . 'App\\Entity\\ModelName' . "\0" . 'specificity', 'lastUpdate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ModelName $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\ModelName
    {
    ...
    public function getSuggestedPrice(): ?float
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSuggestedPrice', []);
     ...
     * {@inheritDoc}
     */
    public function setSuggestedPrice(?float $suggestedPrice): \App\Entity\ModelName
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSuggestedPrice', [$suggestedPrice]);

        return parent::setSuggestedPrice($suggestedPrice);
    }
     ...
     * {@inheritDoc}
     */
    public function setColors(?array $colors): \App\Entity\ModelName
    {
     ...
     * {@inheritDoc}
     */
    public function setHeight(string $height): \App\Entity\ModelName
    {
    ...
    public function getSpecificity(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSpecificity', []);
     ...
     * {@inheritDoc}
     */
    public function setSpecificity(?string $specificity): \App\Entity\ModelName
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSpecificity', [$specificity]);

        return parent::setSpecificity($specificity);
    }
