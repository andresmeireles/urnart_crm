 ...
 */
class ProductionCount extends \App\Entity\ProductionCount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ProductionCount' . "\0" . 'id', '' . "\0" . 'App\\Entity\\ProductionCount' . "\0" . 'model', '' . "\0" . 'App\\Entity\\ProductionCount' . "\0" . 'height', '' . "\0" . 'App\\Entity\\ProductionCount' . "\0" . 'obs', '' . "\0" . 'App\\Entity\\ProductionCount' . "\0" . 'amount', '' . "\0" . 'App\\Entity\\ProductionCount' . "\0" . 'date', '' . "\0" . 'App\\Entity\\ProductionCount' . "\0" . 'color', 'lastUpdate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductionCount $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setModel(string $model): \App\Entity\ProductionCount
    {
    ...
    public function getFullHeight(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFullHeight', []);
     ...
     * {@inheritDoc}
     */
    public function setHeight(string $height): \App\Entity\ProductionCount
    {
     ...
     * {@inheritDoc}
     */
    public function setObs(?string $obs): \App\Entity\ProductionCount
    {
     ...
     * {@inheritDoc}
     */
    public function setAmount(int $amount): \App\Entity\ProductionCount
    {
     ...
     * {@inheritDoc}
     */
    public function setDate(string $productionDate): \App\Entity\ProductionCount
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDate', [$productionDate]);

        return parent::setDate($productionDate);
    }
     ...
     * {@inheritDoc}
     */
    public function setColor(?string $color): \App\Entity\ProductionCount
    {
