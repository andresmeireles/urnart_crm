 ...
 */
class getProductInventoryRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\ProductInventoryRepository' shared autowired service.
     *
     * @return \App\Repository\ProductInventoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductInventoryRepository.php';

        return $container->privates['App\\Repository\\ProductInventoryRepository'] = new \App\Repository\ProductInventoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
