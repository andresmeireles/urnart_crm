 ...
 */
class getManualOrderReportRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\ManualOrderReportRepository' shared autowired service.
     *
     * @return \App\Repository\ManualOrderReportRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ManualOrderReportRepository.php';

        return $container->privates['App\\Repository\\ManualOrderReportRepository'] = new \App\Repository\ManualOrderReportRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
