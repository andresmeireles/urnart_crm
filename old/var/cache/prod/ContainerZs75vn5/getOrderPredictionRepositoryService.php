 ...
 */
class getOrderPredictionRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\OrderPredictionRepository' shared autowired service.
     *
     * @return \App\Repository\OrderPredictionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OrderPredictionRepository.php';

        return $container->privates['App\\Repository\\OrderPredictionRepository'] = new \App\Repository\OrderPredictionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
