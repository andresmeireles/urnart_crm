 ...
 */
class getTravelTruckOrdersRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\TravelTruckOrdersRepository' shared autowired service.
     *
     * @return \App\Repository\TravelTruckOrdersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TravelTruckOrdersRepository.php';

        return $container->privates['App\\Repository\\TravelTruckOrdersRepository'] = new \App\Repository\TravelTruckOrdersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
