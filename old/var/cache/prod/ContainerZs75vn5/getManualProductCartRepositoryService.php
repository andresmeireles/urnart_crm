 ...
 */
class getManualProductCartRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\ManualProductCartRepository' shared autowired service.
     *
     * @return \App\Repository\ManualProductCartRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ManualProductCartRepository.php';

        return $container->privates['App\\Repository\\ManualProductCartRepository'] = new \App\Repository\ManualProductCartRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
