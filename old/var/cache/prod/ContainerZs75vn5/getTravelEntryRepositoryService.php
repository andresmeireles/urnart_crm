 ...
 */
class getTravelEntryRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\TravelEntryRepository' shared autowired service.
     *
     * @return \App\Repository\TravelEntryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TravelEntryRepository.php';

        return $container->privates['App\\Repository\\TravelEntryRepository'] = new \App\Repository\TravelEntryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
