 ...
 */
class getDepartamentRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\DepartamentRepository' shared autowired service.
     *
     * @return \App\Repository\DepartamentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DepartamentRepository.php';

        return $container->privates['App\\Repository\\DepartamentRepository'] = new \App\Repository\DepartamentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
