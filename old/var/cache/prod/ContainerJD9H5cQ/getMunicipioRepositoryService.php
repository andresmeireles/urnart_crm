 ...
 */
class getMunicipioRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\MunicipioRepository' shared autowired service.
     *
     * @return \App\Repository\MunicipioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MunicipioRepository.php';

        return $container->privates['App\\Repository\\MunicipioRepository'] = new \App\Repository\MunicipioRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
