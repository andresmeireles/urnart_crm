 ...
 */
class getProductionCountRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\ProductionCountRepository' shared autowired service.
     *
     * @return \App\Repository\ProductionCountRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductionCountRepository.php';

        return $container->privates['App\\Repository\\ProductionCountRepository'] = new \App\Repository\ProductionCountRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
