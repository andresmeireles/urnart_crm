 ...
 */
class getBoletoRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\BoletoRepository' shared autowired service.
     *
     * @return \App\Repository\BoletoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BoletoRepository.php';

        return $container->privates['App\\Repository\\BoletoRepository'] = new \App\Repository\BoletoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
