 ...
 */
class getTravelAccountabilityRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\TravelAccountabilityRepository' shared autowired service.
     *
     * @return \App\Repository\TravelAccountabilityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TravelAccountabilityRepository.php';

        return $container->privates['App\\Repository\\TravelAccountabilityRepository'] = new \App\Repository\TravelAccountabilityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
