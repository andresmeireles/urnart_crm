 ...
 */
class getModelNameRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\ModelNameRepository' shared autowired service.
     *
     * @return \App\Repository\ModelNameRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ModelNameRepository.php';

        return $container->privates['App\\Repository\\ModelNameRepository'] = new \App\Repository\ModelNameRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
